...
@customElement("sd-icon-panorama-vertical")
export class IconPanoramaVertical extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-panorama-vertical": IconPanoramaVertical;
    }
}