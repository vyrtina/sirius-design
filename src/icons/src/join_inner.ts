...
@customElement("sd-icon-join-inner")
export class IconJoinInner extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-join-inner": IconJoinInner;
    }
}