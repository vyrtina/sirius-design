...
@customElement("sd-icon-no-luggage")
export class IconNoLuggage extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-no-luggage": IconNoLuggage;
    }
}