...
@customElement("sd-icon-perm-data_setting")
export class IconPermDataSetting extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-perm-data_setting": IconPermDataSetting;
    }
}