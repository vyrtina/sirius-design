...
@customElement("sd-icon-sports-tennis")
export class IconSportsTennis extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-sports-tennis": IconSportsTennis;
    }
}