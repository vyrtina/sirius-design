...
@customElement("sd-icon-settings-input_antenna")
export class IconSettingsInputAntenna extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-settings-input_antenna": IconSettingsInputAntenna;
    }
}