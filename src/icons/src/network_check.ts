...
@customElement("sd-icon-network-check")
export class IconNetworkCheck extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-network-check": IconNetworkCheck;
    }
}