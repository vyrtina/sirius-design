...
@customElement("sd-icon-event-repeat")
export class IconEventRepeat extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-event-repeat": IconEventRepeat;
    }
}