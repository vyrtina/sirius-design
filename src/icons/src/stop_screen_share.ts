...
@customElement("sd-icon-stop-screen_share")
export class IconStopScreenShare extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-stop-screen_share": IconStopScreenShare;
    }
}