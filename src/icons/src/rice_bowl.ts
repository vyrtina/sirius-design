...
@customElement("sd-icon-rice-bowl")
export class IconRiceBowl extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-rice-bowl": IconRiceBowl;
    }
}