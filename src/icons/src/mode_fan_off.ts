...
@customElement("sd-icon-mode-fan_off")
export class IconModeFanOff extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-mode-fan_off": IconModeFanOff;
    }
}