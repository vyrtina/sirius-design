...
@customElement("sd-icon-face-retouching_natural")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-face-retouching_natural": IconFaceRetouchingNatural;
    }
}