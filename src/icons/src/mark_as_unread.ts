...
@customElement("sd-icon-mark-as_unread")
export class IconMarkAsUnread extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-mark-as_unread": IconMarkAsUnread;
    }
}