...
@customElement("sd-icon-forward-30")
export class IconForward_30 extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-forward-30": IconForward_30;
    }
}