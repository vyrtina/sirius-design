...
@customElement("sd-icon-sports-hockey")
export class IconSportsHockey extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-sports-hockey": IconSportsHockey;
    }
}