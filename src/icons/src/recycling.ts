...
@customElement("sd-icon-recycling")
export class IconRecycling extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-recycling": IconRecycling;
    }
}