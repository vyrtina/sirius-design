...
@customElement("sd-icon-replay-30")
export class IconReplay_30 extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-replay-30": IconReplay_30;
    }
}