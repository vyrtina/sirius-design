...
@customElement("sd-icon-coronavirus")
export class IconCoronavirus extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-coronavirus": IconCoronavirus;
    }
}