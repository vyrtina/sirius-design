...
@customElement("sd-icon-view-in_ar")
export class IconViewInAr extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-view-in_ar": IconViewInAr;
    }
}