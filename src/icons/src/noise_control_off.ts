...
@customElement("sd-icon-noise-control_off")
export class IconNoiseControlOff extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-noise-control_off": IconNoiseControlOff;
    }
}