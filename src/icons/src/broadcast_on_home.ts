...
@customElement("sd-icon-broadcast-on_home")
export class IconBroadcastOnHome extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-broadcast-on_home": IconBroadcastOnHome;
    }
}