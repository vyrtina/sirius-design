...
@customElement("sd-icon-screen-search_desktop")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-screen-search_desktop": IconScreenSearchDesktop;
    }
}