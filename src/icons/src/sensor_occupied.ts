...
@customElement("sd-icon-sensor-occupied")
export class IconSensorOccupied extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-sensor-occupied": IconSensorOccupied;
    }
}