...
@customElement("sd-icon-edit-location")
export class IconEditLocation extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-edit-location": IconEditLocation;
    }
}