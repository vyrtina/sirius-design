...
@customElement("sd-icon-reduce-capacity")
export class IconReduceCapacity extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-reduce-capacity": IconReduceCapacity;
    }
}