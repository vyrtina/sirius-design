...
@customElement("sd-icon-filter-vintage")
export class IconFilterVintage extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-filter-vintage": IconFilterVintage;
    }
}