...
@customElement("sd-icon-portable-wifi_off")
export class IconPortableWifiOff extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-portable-wifi_off": IconPortableWifiOff;
    }
}