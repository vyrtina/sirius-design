...
@customElement("sd-icon-history-toggle-off")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-history-toggle-off": IconHistoryToggleOff;
    }
}
