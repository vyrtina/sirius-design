...
@customElement("sd-icon-transcribe")
export class IconTranscribe extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-transcribe": IconTranscribe;
    }
}