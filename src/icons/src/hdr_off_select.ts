...
@customElement("sd-icon-hdr-off_select")
export class IconHdrOffSelect extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-hdr-off_select": IconHdrOffSelect;
    }
}