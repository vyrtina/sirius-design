...
@customElement("sd-icon-public-off")
export class IconPublicOff extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-public-off": IconPublicOff;
    }
}