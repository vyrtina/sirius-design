...
@customElement("sd-icon-heart-broken")
export class IconHeartBroken extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-heart-broken": IconHeartBroken;
    }
}