...
@customElement("sd-icon-credit-card-off")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-credit-card-off": IconCreditCardOff;
    }
}
