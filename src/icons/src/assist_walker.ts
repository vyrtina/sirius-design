...
@customElement("sd-icon-assist-walker")
export class IconAssistWalker extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-assist-walker": IconAssistWalker;
    }
}