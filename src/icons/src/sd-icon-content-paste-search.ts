...
@customElement("sd-icon-content-paste-search")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-content-paste-search": IconContentPasteSearch;
    }
}
