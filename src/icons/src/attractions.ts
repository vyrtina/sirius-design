...
@customElement("sd-icon-attractions")
export class IconAttractions extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-attractions": IconAttractions;
    }
}