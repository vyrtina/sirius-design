...
@customElement("sd-icon-thunderstorm")
export class IconThunderstorm extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-thunderstorm": IconThunderstorm;
    }
}