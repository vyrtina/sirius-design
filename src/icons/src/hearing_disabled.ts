...
@customElement("sd-icon-hearing-disabled")
export class IconHearingDisabled extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-hearing-disabled": IconHearingDisabled;
    }
}