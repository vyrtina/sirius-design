...
@customElement("sd-icon-handshake")
export class IconHandshake extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-handshake": IconHandshake;
    }
}