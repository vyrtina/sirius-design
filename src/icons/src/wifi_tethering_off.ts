...
@customElement("sd-icon-wifi-tethering_off")
export class IconWifiTetheringOff extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-wifi-tethering_off": IconWifiTetheringOff;
    }
}