...
@customElement("sd-icon-outdoor-grill")
export class IconOutdoorGrill extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-outdoor-grill": IconOutdoorGrill;
    }
}