...
@customElement("sd-icon-emergency")
export class IconEmergency extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-emergency": IconEmergency;
    }
}