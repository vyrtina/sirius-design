...
@customElement("sd-icon-agriculture")
export class IconAgriculture extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-agriculture": IconAgriculture;
    }
}