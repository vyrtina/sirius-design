...
@customElement("sd-icon-people-alt")
export class IconPeopleAlt extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-people-alt": IconPeopleAlt;
    }
}