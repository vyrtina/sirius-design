...
@customElement("sd-icon-panorama-wide_angle")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-panorama-wide_angle": IconPanoramaWideAngle;
    }
}