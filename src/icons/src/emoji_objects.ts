...
@customElement("sd-icon-emoji-objects")
export class IconEmojiObjects extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-emoji-objects": IconEmojiObjects;
    }
}