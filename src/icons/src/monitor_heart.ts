...
@customElement("sd-icon-monitor-heart")
export class IconMonitorHeart extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-monitor-heart": IconMonitorHeart;
    }
}