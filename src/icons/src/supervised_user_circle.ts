...
@customElement("sd-icon-supervised-user_circle")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-supervised-user_circle": IconSupervisedUserCircle;
    }
}