...
@customElement("sd-icon-share-location")
export class IconShareLocation extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-share-location": IconShareLocation;
    }
}