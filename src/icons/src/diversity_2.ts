...
@customElement("sd-icon-diversity-2")
export class IconDiversity_2 extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-diversity-2": IconDiversity_2;
    }
}