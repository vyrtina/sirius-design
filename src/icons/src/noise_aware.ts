...
@customElement("sd-icon-noise-aware")
export class IconNoiseAware extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-noise-aware": IconNoiseAware;
    }
}