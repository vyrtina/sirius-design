...
@customElement("sd-icon-directions-bus_filled")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-directions-bus_filled": IconDirectionsBusFilled;
    }
}