...
@customElement("sd-icon-app-settings_alt")
export class IconAppSettingsAlt extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-app-settings_alt": IconAppSettingsAlt;
    }
}