...
@customElement("sd-icon-minor-crash")
export class IconMinorCrash extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-minor-crash": IconMinorCrash;
    }
}