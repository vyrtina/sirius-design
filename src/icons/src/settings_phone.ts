...
@customElement("sd-icon-settings-phone")
export class IconSettingsPhone extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-settings-phone": IconSettingsPhone;
    }
}