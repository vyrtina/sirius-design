...
@customElement("sd-icon-snowshoeing")
export class IconSnowshoeing extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-snowshoeing": IconSnowshoeing;
    }
}