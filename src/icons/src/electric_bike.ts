...
@customElement("sd-icon-electric-bike")
export class IconElectricBike extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-electric-bike": IconElectricBike;
    }
}