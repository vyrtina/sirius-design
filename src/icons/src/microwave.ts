...
@customElement("sd-icon-microwave")
export class IconMicrowave extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-microwave": IconMicrowave;
    }
}