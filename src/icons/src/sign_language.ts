...
@customElement("sd-icon-sign-language")
export class IconSignLanguage extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-sign-language": IconSignLanguage;
    }
}