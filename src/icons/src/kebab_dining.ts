...
@customElement("sd-icon-kebab-dining")
export class IconKebabDining extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-kebab-dining": IconKebabDining;
    }
}