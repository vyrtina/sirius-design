...
@customElement("sd-icon-swipe-down")
export class IconSwipeDown extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-swipe-down": IconSwipeDown;
    }
}