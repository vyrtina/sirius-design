...
@customElement("sd-icon-bakery-dining")
export class IconBakeryDining extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-bakery-dining": IconBakeryDining;
    }
}