...
@customElement("sd-icon-find-in_page")
export class IconFindInPage extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-find-in_page": IconFindInPage;
    }
}