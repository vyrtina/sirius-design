...
@customElement("sd-icon-volunteer-activism")
export class IconVolunteerActivism extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-volunteer-activism": IconVolunteerActivism;
    }
}