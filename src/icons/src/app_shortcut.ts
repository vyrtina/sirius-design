...
@customElement("sd-icon-app-shortcut")
export class IconAppShortcut extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-app-shortcut": IconAppShortcut;
    }
}