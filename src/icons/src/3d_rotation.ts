...
@customElement("sd-icon-3d-rotation")
export class Icon3dRotation extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-3d-rotation": Icon3dRotation;
    }
}