...
@customElement("sd-icon-snowboarding")
export class IconSnowboarding extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-snowboarding": IconSnowboarding;
    }
}