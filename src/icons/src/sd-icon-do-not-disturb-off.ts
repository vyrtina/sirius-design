...
@customElement("sd-icon-do-not-disturb-off")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-do-not-disturb-off": IconDoNotDisturbOff;
    }
}
