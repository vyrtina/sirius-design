...
@customElement("sd-icon-psychology")
export class IconPsychology extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-psychology": IconPsychology;
    }
}