...
@customElement("sd-icon-roller-skating")
export class IconRollerSkating extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-roller-skating": IconRollerSkating;
    }
}