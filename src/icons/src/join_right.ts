...
@customElement("sd-icon-join-right")
export class IconJoinRight extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-join-right": IconJoinRight;
    }
}