...
@customElement("sd-icon-shutter-speed")
export class IconShutterSpeed extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-shutter-speed": IconShutterSpeed;
    }
}