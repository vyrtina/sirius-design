...
@customElement("sd-icon-add-home_work")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-add-home_work": IconAddHomeWork;
    }
}