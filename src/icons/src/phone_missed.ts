...
@customElement("sd-icon-phone-missed")
export class IconPhoneMissed extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-phone-missed": IconPhoneMissed;
    }
}