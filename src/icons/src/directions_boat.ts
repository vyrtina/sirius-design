...
@customElement("sd-icon-directions-boat")
export class IconDirectionsBoat extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-directions-boat": IconDirectionsBoat;
    }
}