...
@customElement("sd-icon-filter-tilt_shift")
export class IconFilterTiltShift extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-filter-tilt_shift": IconFilterTiltShift;
    }
}