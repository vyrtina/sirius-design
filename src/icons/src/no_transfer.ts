...
@customElement("sd-icon-no-transfer")
export class IconNoTransfer extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-no-transfer": IconNoTransfer;
    }
}