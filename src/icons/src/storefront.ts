...
@customElement("sd-icon-storefront")
export class IconStorefront extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-storefront": IconStorefront;
    }
}