...
@customElement("sd-icon-elderly-woman")
export class IconElderlyWoman extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-elderly-woman": IconElderlyWoman;
    }
}