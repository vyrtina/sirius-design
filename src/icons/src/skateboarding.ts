...
@customElement("sd-icon-skateboarding")
export class IconSkateboarding extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-skateboarding": IconSkateboarding;
    }
}