...
@customElement("sd-icon-thermostat-auto")
export class IconThermostatAuto extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-thermostat-auto": IconThermostatAuto;
    }
}