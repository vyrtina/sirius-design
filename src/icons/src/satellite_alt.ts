...
@customElement("sd-icon-satellite-alt")
export class IconSatelliteAlt extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-satellite-alt": IconSatelliteAlt;
    }
}