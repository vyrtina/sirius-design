...
@customElement("sd-icon-pest-control")
export class IconPestControl extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-pest-control": IconPestControl;
    }
}