...
@customElement("sd-icon-diversity-3")
export class IconDiversity_3 extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-diversity-3": IconDiversity_3;
    }
}