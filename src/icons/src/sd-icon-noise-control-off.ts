...
@customElement("sd-icon-noise-control-off")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-noise-control-off": IconNoiseControlOff;
    }
}
