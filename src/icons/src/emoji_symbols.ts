...
@customElement("sd-icon-emoji-symbols")
export class IconEmojiSymbols extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-emoji-symbols": IconEmojiSymbols;
    }
}