...
@customElement("sd-icon-diversity-1")
export class IconDiversity_1 extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-diversity-1": IconDiversity_1;
    }
}