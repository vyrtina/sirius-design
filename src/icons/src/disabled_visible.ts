...
@customElement("sd-icon-disabled-visible")
export class IconDisabledVisible extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-disabled-visible": IconDisabledVisible;
    }
}