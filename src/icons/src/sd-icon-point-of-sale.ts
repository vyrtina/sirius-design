...
@customElement("sd-icon-point-of-sale")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-point-of-sale": IconPointOfSale;
    }
}
