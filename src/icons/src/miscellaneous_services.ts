...
@customElement("sd-icon-miscellaneous-services")
export class IconMiscellaneousServices extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-miscellaneous-services": IconMiscellaneousServices;
    }
}