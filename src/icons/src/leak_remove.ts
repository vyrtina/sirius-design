...
@customElement("sd-icon-leak-remove")
export class IconLeakRemove extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-leak-remove": IconLeakRemove;
    }
}