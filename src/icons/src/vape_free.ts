...
@customElement("sd-icon-vape-free")
export class IconVapeFree extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-vape-free": IconVapeFree;
    }
}