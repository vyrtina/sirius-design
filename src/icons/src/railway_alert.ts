...
@customElement("sd-icon-railway-alert")
export class IconRailwayAlert extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-railway-alert": IconRailwayAlert;
    }
}