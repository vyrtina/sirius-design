...
@customElement("sd-icon-video-settings")
export class IconVideoSettings extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-video-settings": IconVideoSettings;
    }
}