...
@customElement("sd-icon-troubleshoot")
export class IconTroubleshoot extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-troubleshoot": IconTroubleshoot;
    }
}