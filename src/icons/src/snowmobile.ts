...
@customElement("sd-icon-snowmobile")
export class IconSnowmobile extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-snowmobile": IconSnowmobile;
    }
}