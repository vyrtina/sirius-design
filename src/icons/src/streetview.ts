...
@customElement("sd-icon-streetview")
export class IconStreetview extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-streetview": IconStreetview;
    }
}