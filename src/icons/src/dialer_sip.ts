...
@customElement("sd-icon-dialer-sip")
export class IconDialerSip extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-dialer-sip": IconDialerSip;
    }
}