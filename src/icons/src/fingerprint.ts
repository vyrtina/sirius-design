...
@customElement("sd-icon-fingerprint")
export class IconFingerprint extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-fingerprint": IconFingerprint;
    }
}