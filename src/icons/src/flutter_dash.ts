...
@customElement("sd-icon-flutter-dash")
export class IconFlutterDash extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-flutter-dash": IconFlutterDash;
    }
}