...
@customElement("sd-icon-assignment")
export class IconAssignment extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-assignment": IconAssignment;
    }
}