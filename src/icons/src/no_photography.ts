...
@customElement("sd-icon-no-photography")
export class IconNoPhotography extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-no-photography": IconNoPhotography;
    }
}