...
@customElement("sd-icon-downloading")
export class IconDownloading extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-downloading": IconDownloading;
    }
}