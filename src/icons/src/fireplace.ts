...
@customElement("sd-icon-fireplace")
export class IconFireplace extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-fireplace": IconFireplace;
    }
}