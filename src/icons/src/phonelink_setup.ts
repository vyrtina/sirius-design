...
@customElement("sd-icon-phonelink-setup")
export class IconPhonelinkSetup extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-phonelink-setup": IconPhonelinkSetup;
    }
}