...
@customElement("sd-icon-airline-seat_flat_angled")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-airline-seat_flat_angled": IconAirlineSeatFlatAngled;
    }
}