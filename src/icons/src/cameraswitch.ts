...
@customElement("sd-icon-cameraswitch")
export class IconCameraswitch extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-cameraswitch": IconCameraswitch;
    }
}