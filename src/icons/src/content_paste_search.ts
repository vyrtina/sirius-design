...
@customElement("sd-icon-content-paste_search")
export class IconContentPasteSearch extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-content-paste_search": IconContentPasteSearch;
    }
}