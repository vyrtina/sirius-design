...
@customElement("sd-icon-assignment-returned")
export class IconAssignmentReturned extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-assignment-returned": IconAssignmentReturned;
    }
}