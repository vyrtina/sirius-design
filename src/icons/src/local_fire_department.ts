...
@customElement("sd-icon-local-fire_department")
export class IconLocalFireDepartment extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-local-fire_department": IconLocalFireDepartment;
    }
}