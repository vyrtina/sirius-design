...
@customElement("sd-icon-emoji-nature")
export class IconEmojiNature extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-emoji-nature": IconEmojiNature;
    }
}