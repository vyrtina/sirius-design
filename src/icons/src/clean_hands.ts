...
@customElement("sd-icon-clean-hands")
export class IconCleanHands extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-clean-hands": IconCleanHands;
    }
}