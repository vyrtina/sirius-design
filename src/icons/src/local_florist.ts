...
@customElement("sd-icon-local-florist")
export class IconLocalFlorist extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-local-florist": IconLocalFlorist;
    }
}