...
@customElement("sd-icon-voice-over_off")
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-voice-over_off": IconVoiceOverOff;
    }
}