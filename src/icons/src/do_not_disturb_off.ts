...
@customElement("sd-icon-do-not_disturb_off")
export class IconDoNotDisturbOff extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-do-not_disturb_off": IconDoNotDisturbOff;
    }
}