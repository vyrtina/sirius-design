...
@customElement("sd-icon-wind-power")
export class IconWindPower extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-wind-power": IconWindPower;
    }
}