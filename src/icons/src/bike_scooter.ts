...
@customElement("sd-icon-bike-scooter")
export class IconBikeScooter extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-bike-scooter": IconBikeScooter;
    }
}