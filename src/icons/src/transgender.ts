...
@customElement("sd-icon-transgender")
export class IconTransgender extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-transgender": IconTransgender;
    }
}