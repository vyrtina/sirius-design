...
@customElement("sd-icon-extension")
export class IconExtension extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-extension": IconExtension;
    }
}