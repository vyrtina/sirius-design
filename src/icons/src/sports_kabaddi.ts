...
@customElement("sd-icon-sports-kabaddi")
export class IconSportsKabaddi extends Icon {
    constructor() {
        super();
...
declare global {
    interface HTMLElementTagNameMap {
        "sd-icon-sports-kabaddi": IconSportsKabaddi;
    }
}