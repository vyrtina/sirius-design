...
import type SdTab from "./tab.js";
import type SdTabPanel from "./tab-panel.js";
...
export default class SdTabGroup extends SdElement {
    ...
    private getAllTabs() {
        ...
        return slot.assignedElements() as SdTab[];
    }

    private getAllPanels() {
        return [...this.body.assignedElements()].filter(
            (el) => el.tagName.toLowerCase() === "sd-tab-panel"
        ) as [SdTabPanel];
    }
