...
export default class SdSidebar extends SdElement {
    ...
    /**
     * Indicates whether the sidebar is visible. You can toggle this attribute to show and hide the sidebar, or you can
    ...
    /**
     * the main content of the page, used with push variant for repositioning.
     * if undefined, the next sibling element is chosen instead
     */
