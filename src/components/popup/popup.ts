...
export default class SdPopup extends SdElement {
    static override styles = unsafeCSS(styles);
    /** A reference to the internal popup container. Useful for animating and styling the popup with JavaScript. */
    @query(".popup") popup?: HTMLElement;
    /**
     * The element the popup will be anchored to. If the anchor lives outside the popup, you can provide the anchor
     ...
     * clipped, using a `fixed` position strategy can often work around it.
     */
    ...
    reposition() {
        ...
        if (this.sync) {
            middleware.push(
                size({
                    apply: ({rects}) => {
                        ...
                        this.getPopup().style.width = syncWidth
                            ? `${rects.reference.width}px`
                            : "";
                        this.getPopup().style.height = syncHeight
            ...
            this.getPopup().style.width = "";
            this.getPopup().style.height = "";
        }
        ...
        computePosition(this.anchorEl, this.getPopup(), {
            ...
            Object.assign(this.getPopup().style, {
                left: `${x}px`,
                top: `${y}px`,
            });
    ...
    private start() {
        ...
        this.cleanup = autoUpdate(this.anchorEl, this.getPopup(), () => {
            this.reposition();
        });
    }
