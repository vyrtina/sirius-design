...
export class SubmenuController implements ReactiveController {
    private host: ReactiveControllerHost & SdMenuItem;
    private popupRef: Ref<SdPopup> = createRef();
    ...
    constructor(host: ReactiveControllerHost & SdMenuItem) {
    ...
    private handleMouseOver = () => {
        if (/*!this.hasSlotController.test("submenu")*/ true) {
            this.enableSubmenu();
        }
    };
