 ...
 */
export function ariaPropertyToAttribute<K extends ARIAProperty | "role">(property: K) {
    return (
        property
            .replace("aria", "aria-")
...
type ARIAPropertyToAttribute<K extends string> = K extends `aria${infer Suffix}Element`
